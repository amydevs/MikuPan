...
float* dtbl_tbl[] = {
    dopen_tbl_dplrn,     dopen_tbl_dplrc,     dopen_tbl_dplrl,
    dopen_tbl_dpsrc,     dopen_tbl_dplln,     dopen_tbl_dpllc,
    dopen_tbl_dplll,     dopen_tbl_dpslc,     dopen_tbl_dpln_dbl0,
    dopen_tbl_dpln_dbl1, dopen_tbl_dplc_dbl0, dopen_tbl_dplc_dbl1,
    dopen_tbl_dpsc_dbl0, dopen_tbl_dpsc_dbl1, dopen_tbl_frc,
    dopen_tbl_frr,       dopen_tbl_flc,       dopen_tbl_flr,
    dopen_tbl_f_dbl0,    dopen_tbl_f_dbl1,    dclose68_tbl,
    dclose69_tbl,        dclose70_tbl,        dclose71_tbl,
    dclose72r_tbl,       dclose72l_tbl,       dclose73r_tbl,
    dclose73l_tbl,       dclose74r_tbl,       dclose74l_tbl,
    dopen_tbl_drot,      dopen_tbl_dpsk,      dopen_tbl_dplk,
};
